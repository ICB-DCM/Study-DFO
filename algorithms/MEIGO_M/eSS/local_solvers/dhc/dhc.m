...
% An implementation with slight modifications of the algorithms described
% in [DeLaMaza, Yuret. Dynamic Hill Climbing].
%
% Input:
...
%   ExpandFactor      : factor of expansion upon success
%   ContractFactor    : factor of contraction upon failure
...
function [tolX,tolFun,maxFunEvals,maxIter,outputFcn,...
    initialStepSize,expandFactor,contractFactor,stuckSearchFactor,barrier,...
    display] = f_extractOptions(options,dim)
% interpret options
