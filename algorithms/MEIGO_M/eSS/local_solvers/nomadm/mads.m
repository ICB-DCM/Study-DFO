...
while i <= m
    ...
    if ~NR
        ...
        ind(i) = [];
        warning('off','all');
        [xval,fval,flag] = linprog(-AA(i,:)',AA(ind,:),bb(ind));
        [xval,fval,flag2] = linprog(-AA(i,:)',AA(ind,:),bb(ind),[],[],[],[], ...
...
if (Options.removeRedundancy)
    ...
    for i = 1:length(ind)
        ...
        indcopy(i) = [];
        warning('off','all');
        [xval,fval,flag] = linprog(-AA(i,:)',AA(indcopy,:),bb(indcopy));
        [xval,fval,flag2] = linprog(-AA(i,:)',AA(indcopy,:),bb(indcopy),[],[],[],[], ...
            optimset('Display','off'));
        flag
        flag2
        warning('on','all');
