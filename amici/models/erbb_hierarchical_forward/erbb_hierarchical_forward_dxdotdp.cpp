...
void dxdotdp_erbb_hierarchical_forward(realtype *dxdotdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *w, const realtype *dwdp) {
switch (ip) {
  case 0: {
  dxdotdp[4] = -k[0]*x[4];
  dxdotdp[5] = k[0]*x[4];
  ...
  case 152: {
  dxdotdp[481] = -k[2]*p[153]*x[481]*dwdp[870];
  dxdotdp[482] = k[2]*p[153]*x[481]*dwdp[870];
