...
void dwdp_jakstat_laplace_hierarchical_adjoint_offsets(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) {
