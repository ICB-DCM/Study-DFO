...
extern void J_jakstat_laplace_hierarchical_adjoint_offsets(realtype *J, const realtype t, const realtype *x, const double *p, const double *k, const realtype *h, const realtype *w, const realtype *dwdx);
extern void JB_jakstat_laplace_hierarchical_adjoint_offsets(realtype *JB, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *xB, const realtype *w, const realtype *dwdx);
extern void JDiag_jakstat_laplace_hierarchical_adjoint_offsets(realtype *JDiag, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx);
extern void JSparse_jakstat_laplace_hierarchical_adjoint_offsets(SlsMat JSparse, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx);
extern void JSparseB_jakstat_laplace_hierarchical_adjoint_offsets(SlsMat JSparseB, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *xB, const realtype *w, const realtype *dwdx);
extern void Jv_jakstat_laplace_hierarchical_adjoint_offsets(realtype *Jv, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *v, const realtype *w, const realtype *dwdx);
extern void JvB_jakstat_laplace_hierarchical_adjoint_offsets(realtype *JvB, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *xB, const realtype *vB, const realtype *w, const realtype *dwdx);
extern void Jy_jakstat_laplace_hierarchical_adjoint_offsets(double *nllh, const int iy, const realtype *p, const realtype *k, const double *y, const double *sigmay, const double *my);
extern void dJydsigma_jakstat_laplace_hierarchical_adjoint_offsets(double *dJydsigma, const int iy, const realtype *p, const realtype *k, const double *y, const double *sigmay, const double *my);
extern void dJydy_jakstat_laplace_hierarchical_adjoint_offsets(double *dJydy, const int iy, const realtype *p, const realtype *k, const double *y, const double *sigmay, const double *my);
extern void dwdp_jakstat_laplace_hierarchical_adjoint_offsets(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void dwdx_jakstat_laplace_hierarchical_adjoint_offsets(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void dxdotdp_jakstat_laplace_hierarchical_adjoint_offsets(realtype *dxdotdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *w, const realtype *dwdp);
extern void dydp_jakstat_laplace_hierarchical_adjoint_offsets(double *dydp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip);
extern void dydx_jakstat_laplace_hierarchical_adjoint_offsets(double *dydx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h);
extern void qBdot_jakstat_laplace_hierarchical_adjoint_offsets(realtype *qBdot, const int ip, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *xB, const realtype *w, const realtype *dwdp);
extern void sigma_y_jakstat_laplace_hierarchical_adjoint_offsets(double *sigmay, const realtype t, const realtype *p, const realtype *k);
extern void sx0_jakstat_laplace_hierarchical_adjoint_offsets(realtype *sx0, const realtype t,const realtype *x0, const realtype *p, const realtype *k, const int ip);
extern void sxdot_jakstat_laplace_hierarchical_adjoint_offsets(realtype *sxdot, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *sx, const realtype *w, const realtype *dwdx, const realtype *J, const realtype *dxdotdp);
extern void w_jakstat_laplace_hierarchical_adjoint_offsets(realtype *w, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h);
extern void x0_jakstat_laplace_hierarchical_adjoint_offsets(realtype *x0, const realtype t, const realtype *p, const realtype *k);
extern void xBdot_jakstat_laplace_hierarchical_adjoint_offsets(realtype *xBdot, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *xB, const realtype *w, const realtype *dwdx);
extern void xdot_jakstat_laplace_hierarchical_adjoint_offsets(realtype *xdot, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void y_jakstat_laplace_hierarchical_adjoint_offsets(double *y, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h);

class Model_jakstat_laplace_hierarchical_adjoint_offsets : public amici::Model_ODE {
public:
    Model_jakstat_laplace_hierarchical_adjoint_offsets() : amici::Model_ODE(9,
                    9,
                    3,
                    3,
                    0,
                    ...
                    std::vector<realtype>(6),
                    std::vector<int>(),
                    std::vector<realtype>{0, 0, 0, 0, 0, 0, 0, 0, 0},
                    std::vector<int>{})
                    {};

    virtual amici::Model* clone() const override { return new Model_jakstat_laplace_hierarchical_adjoint_offsets(*this); };
    ...
    virtual void fJ(realtype *J, const realtype t, const realtype *x, const double *p, const double *k, const realtype *h, const realtype *w, const realtype *dwdx) override {
        J_jakstat_laplace_hierarchical_adjoint_offsets(J, t, x, p, k, h, w, dwdx);
    }
    ...
    virtual void fJB(realtype *JB, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *xB, const realtype *w, const realtype *dwdx) override {
        JB_jakstat_laplace_hierarchical_adjoint_offsets(JB, t, x, p, k, h, xB, w, dwdx);
    }
    ...
    virtual void fJDiag(realtype *JDiag, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx) override {
        JDiag_jakstat_laplace_hierarchical_adjoint_offsets(JDiag, t, x, p, k, h, w, dwdx);
    }
    ...
    virtual void fJSparse(SlsMat JSparse, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx) override {
        JSparse_jakstat_laplace_hierarchical_adjoint_offsets(JSparse, t, x, p, k, h, w, dwdx);
    }
    ...
    virtual void fJSparseB(SlsMat JSparseB, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *xB, const realtype *w, const realtype *dwdx) override {
        JSparseB_jakstat_laplace_hierarchical_adjoint_offsets(JSparseB, t, x, p, k, h, xB, w, dwdx);
    }
    ...
    virtual void fJv(realtype *Jv, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *v, const realtype *w, const realtype *dwdx) override {
        Jv_jakstat_laplace_hierarchical_adjoint_offsets(Jv, t, x, p, k, h, v, w, dwdx);
    }
    ...
    virtual void fJvB(realtype *JvB, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *xB, const realtype *vB, const realtype *w, const realtype *dwdx) override {
        JvB_jakstat_laplace_hierarchical_adjoint_offsets(JvB, t, x, p, k, h, xB, vB, w, dwdx);
    }
    ...
    virtual void fJy(double *nllh, const int iy, const realtype *p, const realtype *k, const double *y, const double *sigmay, const double *my) override {
        Jy_jakstat_laplace_hierarchical_adjoint_offsets(nllh, iy, p, k, y, sigmay, my);
    }
    ...
    virtual void fdJydsigma(double *dJydsigma, const int iy, const realtype *p, const realtype *k, const double *y, const double *sigmay, const double *my) override {
        dJydsigma_jakstat_laplace_hierarchical_adjoint_offsets(dJydsigma, iy, p, k, y, sigmay, my);
    }
    ...
    virtual void fdJydy(double *dJydy, const int iy, const realtype *p, const realtype *k, const double *y, const double *sigmay, const double *my) override {
        dJydy_jakstat_laplace_hierarchical_adjoint_offsets(dJydy, iy, p, k, y, sigmay, my);
    }
    ...
    virtual void fdwdp(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        dwdp_jakstat_laplace_hierarchical_adjoint_offsets(dwdp, t, x, p, k, h, w);
    }
    ...
    virtual void fdwdx(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        dwdx_jakstat_laplace_hierarchical_adjoint_offsets(dwdx, t, x, p, k, h, w);
    }
    ...
    virtual void fdxdotdp(realtype *dxdotdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *w, const realtype *dwdp) override {
        dxdotdp_jakstat_laplace_hierarchical_adjoint_offsets(dxdotdp, t, x, p, k, h, ip, w, dwdp);
    }
    ...
    virtual void fdydp(double *dydp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip) override {
        dydp_jakstat_laplace_hierarchical_adjoint_offsets(dydp, t, x, p, k, h, ip);
    }
    ...
    virtual void fdydx(double *dydx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h) override {
        dydx_jakstat_laplace_hierarchical_adjoint_offsets(dydx, t, x, p, k, h);
    }
    ...
    virtual void fqBdot(realtype *qBdot, const int ip, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *xB, const realtype *w, const realtype *dwdp) override {
        qBdot_jakstat_laplace_hierarchical_adjoint_offsets(qBdot, ip, t, x, p, k, h, xB, w, dwdp);
    }
    ...
    virtual void fsigma_y(double *sigmay, const realtype t, const realtype *p, const realtype *k) override {
        sigma_y_jakstat_laplace_hierarchical_adjoint_offsets(sigmay, t, p, k);
    }
    ...
    virtual void fsx0(realtype *sx0, const realtype t,const realtype *x0, const realtype *p, const realtype *k, const int ip) override {
        sx0_jakstat_laplace_hierarchical_adjoint_offsets(sx0, t, x0, p, k, ip);
    }
    ...
    virtual void fsxdot(realtype *sxdot, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *sx, const realtype *w, const realtype *dwdx, const realtype *J, const realtype *dxdotdp) override {
        sxdot_jakstat_laplace_hierarchical_adjoint_offsets(sxdot, t, x, p, k, h, ip, sx, w, dwdx, J, dxdotdp);
    }
    ...
    virtual void fw(realtype *w, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h) override {
        w_jakstat_laplace_hierarchical_adjoint_offsets(w, t, x, p, k, h);
    }

    virtual void fx0(realtype *x0, const realtype t, const realtype *p, const realtype *k) override {
        x0_jakstat_laplace_hierarchical_adjoint_offsets(x0, t, p, k);
    }
    ...
    virtual void fxBdot(realtype *xBdot, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *xB, const realtype *w, const realtype *dwdx) override {
        xBdot_jakstat_laplace_hierarchical_adjoint_offsets(xBdot, t, x, p, k, h, xB, w, dwdx);
    }
    ...
    virtual void fxdot(realtype *xdot, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        xdot_jakstat_laplace_hierarchical_adjoint_offsets(xdot, t, x, p, k, h, w);
    }

    virtual void fy(double *y, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h) override {
        y_jakstat_laplace_hierarchical_adjoint_offsets(y, t, x, p, k, h);
    }
