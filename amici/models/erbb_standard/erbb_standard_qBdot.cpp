...
void qBdot_erbb_standard(realtype *qBdot, const int ip, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *xB, const realtype *w, const realtype *dwdp) {
switch (ip) {
  case 3: {
  ...
  case 155: {
  qBdot[0] = k[2]*p[156]*x[481]*xB[481]*dwdp[870]-k[2]*p[156]*x[481]*xB[482]*dwdp[870];
