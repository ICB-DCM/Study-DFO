...
void dwdp_erbb_hierarchical_adjoint(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) {
  dwdp[0] = x[8];
  dwdp[1] = x[9];
  dwdp[2] = x[10];
  dwdp[3] = x[12];
