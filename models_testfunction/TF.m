...
% algorithms
    ...
    properties (Constant)
        ...
        himmelblau     = struct(TF.name, 'himmelblau', TF.fun, @TF.f_himmelblau, TF.lb, -5, TF.ub, 5, TF.xbst, [3;2], TF.fbst, 0, TF.dim, 2, TF.smooth, 1, TF.convex, 0, TF.unimodal, 0);
    ...
    methods (Static)
        ...
        function [fval] = f_himmelblau(x)
        % four points with same global minimum 0
            x1 = x(1);
            x2 = x(2);
