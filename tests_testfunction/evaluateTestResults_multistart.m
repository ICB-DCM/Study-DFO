...
saveas(fig, [pwd '/images/smooth-convex-ms.png']); 
...
saveas(fig, [pwd '/images/smooth-convex-all-ms.png']); 
...
saveas(fig, [pwd '/images/dims-ms.png']); 
...
saveas(fig, [pwd '/images/dims-all-ms.png']); 
...
saveas(fig, [pwd '/images/time-ms.png']); 
...
saveas(fig, [pwd '/images/fevals-ms.png']); 
