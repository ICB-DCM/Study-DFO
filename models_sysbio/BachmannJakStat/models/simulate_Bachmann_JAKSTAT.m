% simulate_Bachmann_JAKSTAT.m is the matlab interface to the cvodes mex
...
% USAGE:
% ======
% [...] = simulate_Bachmann_JAKSTAT(tout,theta)
% [...] = simulate_Bachmann_JAKSTAT(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_Bachmann_JAKSTAT(...)
%
% INPUTS:
% =======
...
function varargout = simulate_Bachmann_JAKSTAT(varargin)
...
sol = ami_Bachmann_JAKSTAT(tout,theta(1:27),kappa(1:5),options_ami,plist,pbar(plist+1),xscale,init,data);
if(nargout>1)
