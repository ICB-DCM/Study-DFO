...
switch modeltype
    ...
    case 'foldchange'
        ...
        % long
        D(1).offset([1:4,6]) = [52 44 32 36 58];
        D(1).scaling(1:6) = [92 84 71 76 102 98];
        D(1).name = 'long';
        ...
        % Act
        D(4).offset([1,2,3,6]) = [47 38 30 55];
        D(4).scaling([1,2,3,5,6]) = [87 78 69 101 95];
        D(5).offset = D(4).offset;
        D(5).scaling = D(4).scaling;
        D(4).name = 'ActD';
        D(5).name = 'ActD';
        ...
        % CIsoe
        D(7).offset([1,2,3,4,6]) = [48 39 31 35 56];
        D(7).scaling([1,2,3,4,6]) = [88 79 70 75 96];
        D(8).offset = D(7).offset;
        D(8).scaling = D(7).scaling;
        D(7).name = 'CISoe';
        D(8).name = 'CISoe';
        ...
        % SOCS3oe
        D(11).offset([1,2,3,4,6]) = [54 46 34 37 60];
        D(11).scaling([1,2,3,4,6]) = [94 86 73 77 100];
        D(12).offset = D(11).offset;
        D(12).scaling = D(11).scaling;
        D(11).name = 'SOCS3oe';
        D(12).name = 'SOCS3oe';
        ...
        % SHP1oe
        D(13).offset([1 2 3  6 ]) = [53 45 33 59];
        D(13).scaling([1 2 3 5 6 18]) = [93 85 72 103 99 74];
        D(14).offset = D(13).offset;
        D(14).scaling = D(13).scaling;
        D(13).name = 'SHP1oe';
        D(14).name = 'SHP1oe';
        ...
        % DR 90 min -> group 4
        for cond = 32:36
            D(cond).scaling([19,20]) = [67 68];
            D(cond).name = 'dose response 90 min';
        end
        
        for cond = 1:36
            D(cond).offset = D(cond).offset+4;
            D(cond).scaling = D(cond).scaling-2;
            D(cond).std = D(cond).std-2;
        end
