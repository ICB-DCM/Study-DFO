function performNewMeasurementEC(theta, nMeasure, nTimepoints, sigma2)
...
[exdir, ~, ~] = fileparts(which('performNewMeasurementEC.m'));
fid = fopen([exdir '/getInitialConcentrationsEC.m'], 'w');
fprintf(fid, 'function con0 = getInitialConcentrationsEC()\n\n');
...
fid = fopen([exdir '/getMeasuredDataEC.m'], 'w');
fprintf(fid, 'function yMeasure = getMeasuredDataEC()\n\n');
