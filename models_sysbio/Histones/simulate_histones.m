...
% USAGE:
% ======
% [...] = simulate_histones(tout,theta)
% [...] = simulate_histones(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_histones(...)
%
% INPUTS:
% =======
...
function varargout = simulate_histones(varargin)
