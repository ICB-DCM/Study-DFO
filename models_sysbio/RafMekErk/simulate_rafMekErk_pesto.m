% simulate_rafMekErk_pesto.m is the matlab interface to the cvodes mex
...
% USAGE:
% ======
% [...] = simulate_rafMekErk_pesto(tout,theta)
% [...] = simulate_rafMekErk_pesto(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_rafMekErk_pesto(...)
%
% INPUTS:
% =======
...
function varargout = simulate_rafMekErk_pesto(varargin)
...
sol = ami_rafMekErk_pesto(tout,theta(1:28),kappa(1:2),options_ami,plist,pbar(plist+1),xscale,init,data);
if(nargout>1)
